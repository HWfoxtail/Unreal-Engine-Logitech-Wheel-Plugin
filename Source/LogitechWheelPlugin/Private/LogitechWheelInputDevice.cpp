	...
	MessageHandler(InMessageHandler)
{
	...
	InputDeviceIndex = 0;
	GConfig->GetInt(
		TEXT("LogitechWheelInput"),
		TEXT("LogitechWheelDeviceIndex"),
		InputDeviceIndex,
		GGameIni);

	IsDeviceAvailable(InputDeviceIndex);
	...
	_buttonKeys[6] = ILogitechWheelPlugin::LogitechSW_WheelR2;
	_buttonKeys[7] = ILogitechWheelPlugin::LogitechSW_WheelL2;
	_buttonKeys[8] = ILogitechWheelPlugin::LogitechSW_WheelShare;
	_buttonKeys[9] = ILogitechWheelPlugin::LogitechSW_WheelOption;
	_buttonKeys[10] = ILogitechWheelPlugin::LogitechSW_WheelR3;
	_buttonKeys[11] = ILogitechWheelPlugin::LogitechSW_WheelL3;

	_buttonKeys[19] = ILogitechWheelPlugin::LogitechSW_WheelAdd;
	_buttonKeys[20] = ILogitechWheelPlugin::LogitechSW_WheelMinus;

	_buttonKeys[23] = ILogitechWheelPlugin::LogitechSW_WheelEnter;
...
void FLogitechWheelInputDevice::SendControllerEvents()
{
	...
	if (!IsDeviceAvailable(InputDeviceIndex))
	{
		//UE_LOG(LogTemp, Warning, TEXT("Device Not Available"));
		return;
	}

	currentState = ConvertDeviceState(InputDevice.WheelGetState(InputDeviceIndex));
