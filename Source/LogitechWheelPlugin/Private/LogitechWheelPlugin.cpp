...
const FKey ILogitechWheelPlugin::LogitechSW_WheelR2("WheelR2");
const FKey ILogitechWheelPlugin::LogitechSW_WheelL2("WheelL2");
const FKey ILogitechWheelPlugin::LogitechSW_WheelShare("WheelShare");
const FKey ILogitechWheelPlugin::LogitechSW_WheelOption("WheelOption");
const FKey ILogitechWheelPlugin::LogitechSW_WheelR3("WheelR3");
const FKey ILogitechWheelPlugin::LogitechSW_WheelL3("WheelL3");
const FKey ILogitechWheelPlugin::LogitechSW_WheelAdd("WheelAdd");
const FKey ILogitechWheelPlugin::LogitechSW_WheelMinus("WheelMinus");

const FKey ILogitechWheelPlugin::LogitechSW_WheelEnter("WheelEnter");
...
TSharedPtr<class IInputDevice> FLogitechWheelPlugin::CreateInputDevice(const TSharedRef<FGenericApplicationMessageHandler>& InMessageHandler)
{
	...
	EKeys::AddKey(FKeyDetails(ILogitechWheelPlugin::LogitechSW_WheelR2, LOCTEXT("WheelR2", "Logitech Wheel Button R2"), FKeyDetails::GamepadKey));
	EKeys::AddKey(FKeyDetails(ILogitechWheelPlugin::LogitechSW_WheelL2, LOCTEXT("WheelL2", "Logitech Wheel Button L2"), FKeyDetails::GamepadKey));
	EKeys::AddKey(FKeyDetails(ILogitechWheelPlugin::LogitechSW_WheelShare, LOCTEXT("WheelShare", "Logitech Wheel Button Share"), FKeyDetails::GamepadKey));
	EKeys::AddKey(FKeyDetails(ILogitechWheelPlugin::LogitechSW_WheelOption, LOCTEXT("WheelOption", "Logitech Wheel Button Option"), FKeyDetails::GamepadKey));
	EKeys::AddKey(FKeyDetails(ILogitechWheelPlugin::LogitechSW_WheelR3, LOCTEXT("WheelR3", "Logitech Wheel Button R3"), FKeyDetails::GamepadKey));
	EKeys::AddKey(FKeyDetails(ILogitechWheelPlugin::LogitechSW_WheelL3, LOCTEXT("WheelL3", "Logitech Wheel Button L3"), FKeyDetails::GamepadKey));
	EKeys::AddKey(FKeyDetails(ILogitechWheelPlugin::LogitechSW_WheelAdd, LOCTEXT("WheelAdd", "Logitech Wheel Button Add"), FKeyDetails::GamepadKey));
	EKeys::AddKey(FKeyDetails(ILogitechWheelPlugin::LogitechSW_WheelMinus, LOCTEXT("WheelMinus", "Logitech Wheel Button Minus"), FKeyDetails::GamepadKey));
	EKeys::AddKey(FKeyDetails(ILogitechWheelPlugin::LogitechSW_WheelEnter, LOCTEXT("WheelEnter", "Logitech Wheel Button Enter"), FKeyDetails::GamepadKey));
